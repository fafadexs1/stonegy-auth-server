  ...
  try {
    ...
    try {
      ...
      await client.query(`
        ...
        CREATE INDEX IF NOT EXISTS idx_stonegy_events_user ON stonegy_events(username, created_at DESC);
        CREATE INDEX IF NOT EXISTS idx_stonegy_events_type ON stonegy_events(event_type, created_at DESC);
        CREATE INDEX IF NOT EXISTS idx_stonegy_events_economy ON stonegy_events(event_type, username, created_at DESC)
          WHERE event_type IN ('ECONOMY_SNAPSHOT', 'GOLD_OUT', 'GOLD_IN', 'POTION_CONSUMED');
      `);
