...
export async function ensureDbSchema() {
  ...
  try {
    ...
    try {
      // 1. Tabela de Usuários (com suporte a ADMIN e ROLES)
      await client.query(`
      ...
      // Garantir que colunas role e is_admin existam em tabelas antigas
      await client.query(`
        DO $$ 
        BEGIN 
          BEGIN
      ...
      // Seed Usuário Admin Principal (fabricio / 123456)
      ...
      await client.query(`
        ...
        ('discord_webhook', ''),
        ('admin_invite_code', 'ADMIN-2026-KEY')
